...
//     [ApiController]
//     [MiddlewareFilter(typeof(RolePermissionizationCheck))]
//     [MiddlewareFilter(typeof(RolePermissionizationRole))]
...
//             if (query.Pagination)
//             {
//                 var rolePermissionsRepo = this.rolePermissionApplication.GetList(query.Search, query.Page, query.PerPage);
//                 int count = this.rolePermissionApplication.Count(query.Search);
