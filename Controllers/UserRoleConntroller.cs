...
//     [ApiController]
//     [MiddlewareFilter(typeof(UserRoleizationCheck))]
//     [MiddlewareFilter(typeof(UserRoleizationRole))]
...
//             if (query.Pagination)
//             {
//                 var userRolesRepo = this.userRoleApplication.GetList(query.Search, query.Page, query.PerPage);
